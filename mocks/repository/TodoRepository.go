...
import (
	models "_/home/alfenfebral/go-workspace/go-clean-architecture/models"
...
func (_m *TodoRepository) Store(value primitive.M) (*models.Todo, error) {
	ret := _m.Called(value)

	var r0 *models.Todo
	if rf, ok := ret.Get(0).(func(primitive.M) *models.Todo); ok {
		r0 = rf(value)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Todo)
...
func (_m *TodoRepository) Update(id string, value primitive.D) (*models.Todo, error) {
	ret := _m.Called(id, value)

	var r0 *models.Todo
	if rf, ok := ret.Get(0).(func(string, primitive.D) *models.Todo); ok {
		r0 = rf(id, value)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*models.Todo)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, primitive.D) error); ok {
		r1 = rf(id, value)
	} else {
		r1 = ret.Error(1)
	}
